...
fn main() {
	...
	let _ = new_builder(&openssl_path, &nginx_path)
		...
		.whitelisted_function("^SSL_set_(ocsp_response|signed_cert_timestamp_list|private_key_method|session_id_context)$")
		...
		.whitelisted_function("SSL_use_certificate_ASN1")
		.whitelisted_function("SSL_add_chain_cert_ASN1")
		// rust_openssl.h
